...
function Login() {
  ...
  return (
    <div className="flex justify-center items-center h-[80vh]">
      <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl w-96 border border-gray-100 dark:border-gray-700">
        <h2 className="text-2xl font-bold mb-6 text-center text-blue-600 dark:text-blue-400">Login to LukWealth</h2>
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4">
          <div>
            ...
            <input 
              type="email" 
              className="w-full px-3 py-2 border dark:border-gray-600 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50 dark:bg-gray-700 dark:text-white"
              value={email} 
